export const questions = {
  "Seção 1 - Autodiagnóstico da empresa em relação a LGPD": {
    weight: 0,
    category: "Prezado(a), A Lei Geral de Proteção de Dados (LGPD) é um marco importante na regulamentação do tratamento de dados pessoais no Brasil. Com a sua implementação, todas as organizações precisam assegurar que os dados pessoais que coletam, armazenam e utilizam estão protegidos e são manejados de forma adequada, garantindo a privacidade e os direitos dos titulares. Neste contexto, estamos empenhados em promover a conformidade com a LGPD, visando proteger as informações pessoais de clientes, parceiros e colaboradores. Para isso, desenvolvemos este formulário de autodiagnóstico, que tem como objetivo avaliar o atual estágio de adequação à LGPD da sua empresa e identificar áreas que necessitam de melhorias. A sua participação é essencial para o sucesso desta iniciativa. Pedimos que responda ao formulário de forma clara e objetiva, fornecendo informações precisas sobre os processos e práticas relacionadas ao tratamento de dados pessoais em sua área de atuação. Suas respostas nos ajudarão a mapear o nível de conformidade da sua empresa e a planejar as ações necessárias para assegurar que todas as operações estejam em conformidade com a legislação vigente. Reforçamos que todas as informações fornecidas serão tratadas com a máxima confidencialidade e serão utilizadas exclusivamente para fins de adequação à LGPD.",
  },
  "Seção 2 - Informações gerais": {
    weight: 0,
    category: "As informações que solicitamos serão tratadas com o mais alto grau de confidencialidade e serão usadas apenas para fins de pesquisa acadêmica. Não divulgaremos informações específicas da sua empresa sem o seu consentimento prévio. Estamos cientes da sensibilidade das informações solicitadas e garantimos que todas as medidas de segurança apropriadas serão tomadas para proteger os dados fornecidos.",
  ...
  "Seção 10 - Feedback": {
    weight: 0,
    category: "Estamos constantemente buscando melhorar nossas ferramentas, e para isso, precisamos da sua ajuda. Seu feedback é extremamente valioso para nós e nos ajudará a garantir que o formulário atenda melhor às necessidades de todos.",
  },
};

export const maturityLevels = {
  1: { min_score: 0, max_score: 53 },
  2: { min_score: 54, max_score: 94 },
  3: { min_score: 95, max_score: 130 },
  4: { min_score: 131, max_score: 160 },
  5: { min_score: 161, max_score: 171 }
};
